...
'<nav id="nav-menu" class="col-lg-2 col-md-3 col-sm-6" style="background-color: #FAFFC1; height: 100vh;">
    ...
    <div class="mt-5">
        ...
        <a href="#" class="mt-3 w-75 mx-auto text-dark btn btn-outline-info nav-link border-0"><img src="./Icones/Course.svg" alt="Course-icone" style="margin-right: 30px;">Course&nbsp;&nbsp;</a>
